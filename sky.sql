...
CREATE TABLE `category` (
                            `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
                            `type` int DEFAULT NULL COMMENT '类型   1 货物分类 2 套餐分类',
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin COMMENT='货物及货物套餐分类';
...
CREATE TABLE `dish` (
                        `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
                        `name` varchar(32) COLLATE utf8_bin NOT NULL COMMENT '货物名称',
                        `category_id` bigint NOT NULL COMMENT '货物分类id',
                        `price` decimal(10,2) DEFAULT NULL COMMENT '货物价格',
...
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin COMMENT='货物';
...
CREATE TABLE `dish_flavor` (
                               `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
                               `dish_id` bigint NOT NULL COMMENT '货物',
                               `name` varchar(32) COLLATE utf8_bin DEFAULT NULL COMMENT '货物风格名称',
                               `value` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '风格数据list',
                               PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=104 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin COMMENT='货物与商家口味之间关系表';
...
CREATE TABLE `order_detail` (
                                ...
                                `dish_id` bigint DEFAULT NULL COMMENT '货物id',
                                `setmeal_id` bigint DEFAULT NULL COMMENT '货物套餐id',
                                `dish_flavor` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '货物特殊口味',
...
CREATE TABLE `setmeal_dish` (
                                ...
                                `setmeal_id` bigint DEFAULT NULL COMMENT '货物套餐id',
                                `dish_id` bigint DEFAULT NULL COMMENT '货物id',
                                `name` varchar(32) COLLATE utf8_bin DEFAULT NULL COMMENT '货物名称 （冗余字段）',
                                `price` decimal(10,2) DEFAULT NULL COMMENT '货物单价（冗余字段）',
                                `copies` int DEFAULT NULL COMMENT '货物份数',
                                PRIMARY KEY (`id`)
